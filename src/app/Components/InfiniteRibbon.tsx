...
export const InfiniteRibbon = () => {
  return (
    <div className="relative z-[500] h-[111px] overflow-hidden w-full bg-primary flex items-center">
...
export const BigInfiniteRibbon = () => {
  return (
    <div className="relative z-[500] h-[150px] sm:h-[273px] overflow-hidden w-full bg-primary flex items-center">
      <div className="flex items-center tracking-[-0.12em] text-[100px] sm:text-[200px] gap-6 text-black-state">
        <h2 className="whitespace-nowrap ribbon text-black-state">
          WORK WITH US
        </h2>
        <h2 className="whitespace-nowrap ribbon text-black-state">
          WORK WITH US
